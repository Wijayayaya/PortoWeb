          ...
          <div className="card slide-in h-100">
            ...
            <div className="card-body d-flex flex-column">
              ...
              <div className="mt-auto d-flex flex-row mb-3 slide-in">
                <a href="https://euphonious-axolotl-ed0835.netlify.app/" target="_blank" rel="noopener noreferrer" className="btn btn-warning me-2">
                  Live
                </a>
                <a href="https://github.com/Wijayayaya/bookshelf-apps" target="_blank" rel="noopener noreferrer" className="btn btn-warning">
                  Code
                </a>
              </div>
            </div>
        ...
        <div className="col">
          <div className="card slide-in h-100">
            ...
            <div className="card-body d-flex flex-column">
              ...
              <div className="mt-auto d-flex flex-row mb-3 slide-in">
                <a href="https://dashadm.netlify.app/" target="_blank" rel="noopener noreferrer" className="btn btn-warning me-2">
                  Live
                </a>
                <a href="https://github.com/Wijayayaya/Dashboard-Admin-PFS" target="_blank" rel="noopener noreferrer" className="btn btn-warning">
                  Code
                </a>
              </div>
            </div>
